    ...
    def EditScooter(self, db, loggingSys):
        try:
            ...
            editable_fields = {
                ...
                "top_speed":           [ lambda v: InputValidation.ValidateSpeed(v), "5-120" ],
...
class SystemAdministrator(Service):
    ...
    def CreateScooter(self, db, loggingSys):
        try:
            ...
            scooter["top_speed"] = ask("Top Speed", "Enter top speed (km/h):", lambda v: InputValidation.ValidateSpeed(v), "0-50")
